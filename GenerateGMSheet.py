...
# def LinearizeMatchDaySchedule (sheet, preseasonDays, matchDays,  playoffDays, spacing, hasLunarConference=True):
...
StatsInfo = []
StatsInfo.append({"sheet" : RPVSheet, "sheetName": "Sorted RPV", "skiprows": 4, "usecols": "A:AD", "nrows": 848})
StatsInfo.append({"sheet" : SBVSheet,"sheetName": "Sorted Player Stats", "skiprows": 0, "usecols": "D:AQ", "nrows": 848})
StatsInfo.append({"sheet" : IDRSheet,"sheetName": "IDR View", "skiprows": 4, "usecols": "A:AQ", "nrows": 848})
